...
export const PROJECTS: Project[] = [
  ...
  {
    imagePath: "/assets/task-flow/landing-1.webp",
    path: "task-flow",
    name: "task-flow.name",
    description: "task-flow.description",
    paragraph: "task-flow.paragraph",
    role: "task-flow.role",
    collaborators: ["Brayan Gómez"],
    duration: "task-flow.duration",
    tools: ["React", "Node JS", "Tailwind"],
    website: "https://tasks-front-end.vercel.app/",
    code: "https://github.com/brayang222/Tasks-FrontEnd.git",
    images: [
      { img: "/assets/task-flow/landing-1.webp", text: "task-flow.images" },
      { img: "/assets/task-flow/landing-2.webp", text: "task-flow.images" },
      { img: "/assets/task-flow/landing-3.webp", text: "task-flow.images" },
      { img: "/assets/task-flow/tasks.webp", text: "task-flow.images" },
      { img: "/assets/task-flow/new-task.webp", text: "task-flow.images" },
      { img: "/assets/task-flow/users.webp", text: "task-flow.images" },
    ],
  },
  {
